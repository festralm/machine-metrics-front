        ...
        <div class="modal-content">
            ...
            <table class="equipment-table">
                <tr class="name">
                    ...
                    <td class="value"><input type="text" v-model="addressData.address" id="address"></td>
                </tr>
                <tr class="name">
                    <td class="label"><label for="unit">Подразделение</label></td>
                    <td class="value">
                        <select id="unit" v-model="addressData.unit">
                            <option value=""></option>
                ...
                <tr class="name">
                    <td class="label">
                        <button class="button" @click="saveAddress">Сохранить</button>
                    </td>
                    <td class="value">
...
export default {
    ...
    methods: {
        ...
        saveAddress() {
            this.$emit('save', this.addressData);
            this.addressData = {
                address: '',
                unit: null,
            }
